...
export const buildAnalysisPrompt = ({
  ...
  return [
    ...
    '- deck_title 应该是可工作的演讲标题，而不是机械复述输入第一句。',
    '- title_hint 只是输入提示，不是最终标题。',
    '- 如果 title_hint 看起来像开场白、问候语、口头引入或明显弱标题，例如「大家好」「你好」「今天我想聊聊」，必须重写 deck_title。',
    '- 如果输入没有显式标题，就根据核心主题生成一个工作标题。',
