...
import type { ClarificationQuestion, OutlineResult, PlanContext } from './types.js';
...
export function buildClarification(markdown: string, _context?: PlanContext): ClarificationQuestion[] | null {
...
export function buildClarificationFromPlan(outline: OutlineResult, _context?: PlanContext): ClarificationQuestion[] | null {
